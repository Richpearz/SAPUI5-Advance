		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#fioriappemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriappemployees-display": {
								"semanticObject": "fioriappemployees",
								"action": "display",
								"description": "Employees Fiori App",
								"title": "Employees",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriapp.employees",
									"url": sap.ui.require.toUrl("fioriapp/employees")
								}
							}
						}
					}
